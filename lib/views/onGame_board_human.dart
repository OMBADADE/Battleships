...
class OnGoingGameBoard extends StatefulWidget {
  final String baseUrl = "http://165.227.117.48/games/";
  final String gameId;
  bool isCompleted;

  OnGoingGameBoard({super.key, required this.gameId, this.isCompleted = false});

  @override
  State<OnGoingGameBoard> createState() => _OnGoingGameBoardState();
}

class _OnGoingGameBoardState extends State<OnGoingGameBoard> {
      ...
      if (ans['won']) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: ans['sunk_ship']
                ? const Text("Strike!!! You Sunk an Enemy Ship")
                        ...
                        child: Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              splashColor: shouldBeGiven && !widget.isCompleted
                                  ? Colors.blue
                                  : Colors.white,
                              child: Center(
                                child: GetIcons(
