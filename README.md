Created a Battleship Game that can be played on the live server between different users and there is an option also to play with the AI model that is build in it.
